...
public class GameManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        if ((player == null) && (FindAnyObjectByType<Controller>() != null))
        {
            player = FindAnyObjectByType<Controller>().gameObject;
        }
    ...
    {
        List<EnemySpawner> enemySpawners = FindObjectsByType<EnemySpawner>().ToList();
        List<Enemy> staticEnemies = FindObjectsByType<Enemy>().ToList();
